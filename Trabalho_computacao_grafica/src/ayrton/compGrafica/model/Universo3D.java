...
public class Universo3D {
    ...
    public Universo3D() {
		...
		this.inicio = new Ponto3D();
		this.fim = new Ponto3D();
		this.objetos = new ArrayList<Modelo>();
	}

	public Universo3D(String unidade, Janela janela, Ponto3D inicio, Ponto3D fim) {
		super();
	...
	public String toString() {
		return "Universo3D [unidade=" + unidade + ", janela=" + janela + ", inicio=" + inicio + ", fim=" + fim
				+ ", objetos=" + objetos + "]";
	}
